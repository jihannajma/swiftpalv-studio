...
<head>
    ...
    <!-- Favicons -->
    <link href="assets/img/swiftpalv-logo2.png" rel="icon">
    <link href="assets/img/swiftpalv-logo2.png" rel="apple-touch-icon">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
                ...
                <img src="assets/img/swiftpalv-logo2.png" alt="">
                <h1 class="sitename">swiftpalv-studio</h1>
            </a>
    ...
    <main class="main">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h1 class="mb-4">
                                ...
                                <span class="accent-text">Swiftpalv Studio</span>
                            </h1>

                            <p class="mb-4 mb-md-5">
                              Menggabungkan teknologi canggih dan desain intuitif, SwiftPalv Studio memberikan solusi digital yang berfokus pada efisiensi dan pengalaman pengguna. Kami hadir untuk membawa ide Anda ke level berikutnya.
                            </p>
                    ...
                    <div class="tab-pane fade active show" id="features-tab-1">
                        <div class="row">
                            <div
                                ...
                                <h3>Communicate to Client</h3>
                                <p class="fst-italic">
                                  Membangun komunikasi yang jelas dan efektif untuk memastikan kolaborasi yang sukses antara tim dan klien.
                                </p>
                                {{-- <ul>
                    ...
                    <div class="tab-pane fade" id="features-tab-2">
                        <div class="row">
                            <div
                                ...
                                <p class="fst-italic">
                                  Tim Programmer dan Designer yang berdedikasi dan berpengalaman untuk membantu Anda mewujudkan ide Anda.
                                </p>
                                {{-- <ul>
                                    <li><i class="bi bi-check2-all"></i> <span>Ullamco laboris nisi ut aliquip ex ea
                                            commodo consequat.</span></li>
                    ...
                    <div class="tab-pane fade" id="features-tab-3">
                        <div class="row">
                            <div
                                class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                <h3>
                                  Optimize and Support your Business
                                </h3>
                                {{-- <ul>
                                    <li><i class="bi bi-check2-all"></i> <span>Ullamco laboris nisi ut aliquip ex ea
                                            commodo consequat.</span></li>
                                ...
                                <p class="fst-italic">
                                  Mengoptimalkan sistem dan proses untuk memastikan efisiensi maksimal dan kinerja yang stabil.
                                </p>
                            </div>
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="feature-box orange">
                            ...
                            <h4>Communicate</h4>
                            <p>
                              Menjembatani komunikasi antara klien dan tim untuk menciptakan kerja sama yang efisien dan efektif.
                            </p>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="feature-box blue">
                            ...
                            <h4>Innovate</h4>
                            <p>
                              Menghadirkan solusi digital yang inovatif dan kreatif untuk memenuhi kebutuhan bisnis Anda.
                            </p>
                        </div>
                    </div><!-- End Feature Borx-->
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                        <div class="feature-box green">
                            ...
                            <h4>Develop</h4>
                            <p>
                              Mengembangkan solusi teknologi yang sesuai dengan kebutuhan unik bisnis Anda, dari perencanaan hingga implementasi
                            </p>
                        </div>
                    </div><!-- End Feature Borx-->
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row content justify-content-center align-items-center position-relative">
                    <div class="col-lg-8 mx-auto text-center">
                        <h2 class="display-4 mb-4">Mari Bergabung dengan Kami</h2>
                        <p class="mb-4">Bersama-sama kita wujudkan ide-ide kreatif Anda menjadi kenyataan. Bergabunglah dengan kami dan rasakan pengalaman yang luar biasa.</p>
        ...
        <section id="testimonials" class="testimonials section light-background">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Testimonials</h2>
                <p>Butuh testimoni? Lihat apa yang klien kami katakan</p>
            </div><!-- End Section Title -->
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                      <div class="service-card d-flex">
                        ...
                        <div>
                          ...
                          <p>We provide high-quality web development services to help you build a strong online presence.</p>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                      <div class="service-card d-flex">
                        ...
                        <div>
                          ...
                          <p>Our team specializes in creating innovative mobile applications for both Android and iOS platforms.</p>
                          <a href="service-details.html" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div>
                    </div><!-- End Service Card -->
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                      <div class="service-card d-flex">
                        ...
                        <div>
                          ...
                          <p>Our graphic design services will help you create visually appealing and effective designs for your brand.</p>
                          <a href="service-details.html" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div>
                    </div><!-- End Service Card -->
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                      <div class="service-card d-flex">
                        ...
                        <div>
                          <h3>UI Design</h3>
                          <p>We offer UI design services to create user-friendly and aesthetically pleasing interfaces for your applications.</p>
                          <a href="service-details.html" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div>
                    </div><!-- End Service Card -->
